export default function Main(){
    ...
    <>
    {/* <!-- Hero Section Begin --> */}
    <section className="hero-section set-bg set-bg1" >
            ...
            <div className="row">
                <div className="col-lg-6">
                    <div className="services-pic">
                        <img src="assets/img/services/servicepic1.jpg" alt=""/>
                    </div>
                </div>
                <div className="col-lg-6">
        ...
        <div className="container">
            ...
            <div className="row classes-slider owl-carousel">
                <div className="col-lg-4">
                    <div className="single-class-item set-bg set-bg2" >
                ...
                <div className="col-lg-4">
                    <div className="single-class-item set-bg set-bg4" >
                        <div className="si-text">
                            <h4>Running</h4>
                            <span><i className="fa fa-user"></i> Randy Rivera</span>
                        </div>
                    </div>
                    <div className="single-class-item set-bg set-bg5">
                        <div className="si-text">
                            <h4>Dance</h4>
                ...
                <div className="col-lg-4">
                    <div className="single-class-item set-bg set-bg6">
                        <div className="si-text">
                            <h4>Personal Training</h4>
                            <span><i className="fa fa-user"></i> Cole Robertson</span>
                        </div>
                    </div>
                    <div className="single-class-item set-bg set-bg7" >
                        <div className="si-text">
                            <h4>Weight Loss</h4>
                ...
                <div className="col-lg-4">
                    <div className="single-class-item set-bg set-bg8">
                        <div className="si-text">
                            <h4>Personal Training</h4>
                            <span><i className="fa fa-user"></i> Cole Robertson</span>
                        </div>
                    </div>
                    <div className="single-class-item set-bg set-bg9">
                        <div className="si-text">
                            <h4>Weight Loss</h4>
                            <span><i className="fa fa-user"></i> Ryan Scott</span>
                        </div>
            ...
            <div className="row">
                <div className="col-lg-4 col-md-6">
                    <div className="single-trainer-item">
                        <img src="assets/img/product/football.png" alt=""/>
                        <div className="trainer-text">
                            <h5>Football</h5>
                            <span>All types of footballs</span>
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="single-trainer-item">
                        <img src="assets/img/product/bat2.png" alt=""/>
                        <div className="trainer-text">
                            <h5>Cricket-bat</h5>
                            <span>All types of cricket-bats</span>
                            <p>non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat
                                voluptatem.</p>
                            <div className="trainer-social">
                                <a href="#"><i className="fa fa-facebook"></i></a>
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="single-trainer-item">
                        <img src="assets/img/product/t-sirt.png" alt=""/>
                        <div className="trainer-text">
                            <h5>sport cloth</h5>
                            <span>All types of sport cloths</span>
                            <p>non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat
                                voluptatem.</p>
                            <div className="trainer-social">
                                <a href="#"><i className="fa fa-facebook"></i></a>
    ...
    <section className="banner-section set-bg set-bg10" >
        <div className="container">
            <div className="row">
                <div className="col-lg-6">
                ...
                <div className="col-lg-5">
                    <img src="assets/img/p2.png" alt="" style={{height:"500px"}}/>
                </div>
            </div>
        </div>
    </section>
            ...
            <div className="row">
                <div className="col-lg-4 col-md-6">
                    <div className="single-blog-item">
                        <img src="assets/img/register1.jpg" alt="" style={{height:"270px"}}/>
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="single-blog-item">
                        <img src="assets/img/img6.jpg" alt="" style={{height:"270px"}}/>
                        <div className="blog-widget">
                            <div className="bw-date">February 17, 2019</div>
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="single-blog-item">
                        <img src="assets/img/img5.jpg" alt="" style={{height:"270px"}}/>
                        <div className="blog-widget">
                            <div className="bw-date">February 17, 2019</div>
                            <a href="#" className="tag">#Stedium</a>
                        </div>
    ...
    <section className="footer-banner">
        <div className="container-fluid">
            <div className="row">
                <div className="col-lg-6">
                    <div className="footer-banner-item set-bg set-bg11" >
                ...
                <div className="col-lg-6">
                    <div className="footer-banner-item set-bg set-bg12">
